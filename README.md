 ...
 * de pouvoir en jouir sur toutes les plateformes
...
(ceux que je connais en tout cas) 
...
Vous savez *traduire* ? Connaissez vous assez le *brassage* pour m'aider à améliorer les formules ? Vous êtes *développeur pythoniste amateur de bière*  ? Vous *voulez* m'envoyer un chèque ? Peut-être plutôt *webdesigner* ?
